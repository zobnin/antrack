...
fun CharSequence.backgroundColor(color: Int): CharSequence = applyStyles(BackgroundColorSpan(color))
...
fun CharSequence.color(color: Int): CharSequence = applyStyles(ForegroundColorSpan(color))
